''' Crumbles.py
    ...
    Version 0.1.4 - 06/12/2012 - for Python 2.7.3
'''
    ...
    def run(self):
        ...
        while self.external.poll() is None:
            try:
                ...
                message = self.external.readline()[:-2] # [:-1] to remove the '\r\n' ending
...
class Manager():
    ...
    def createSolver(self, path, evaluatorsDict):
        ...
        self.activeProcesses[SOLVER_KEY][newSolver.id] = newSolver.run()
    ...
    def createEvaluator(self, path, function, functionCall):
        ...
        self.activeProcesses[EVALUATOR_KEY][newEvaluator.id] = newEvaluator.run()
    ...
    def execute(self):
        ...
        for activeSolvs in self.activeProcesses[SOLVER_KEY]:
            ...
            print 'Solver Primed: ' + SOLVER_KEY + activeSolvs
        ...
        for activeEvals in self.activeProcesses[EVALUATOR_KEY]:
            ...
            print 'Evaluator Primed: ' + EVALUATOR_KEY + activeEvals
